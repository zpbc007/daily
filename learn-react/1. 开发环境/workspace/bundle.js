...
/******/ 	var hotCurrentHash = "20ee759e3db7b43e8c08"; // eslint-disable-line no-unused-vars
...
(0, _reactDom.render)(_react2.default.createElement(_Todo2.default, null), document.getElementById('root'));
...
var Todo = function (_React$Component) {
    ...
    function Todo(props, context) {
        ...
        _this.submitFn = _this.submitFn.bind(_this);
        _this.delFn = _this.delFn.bind(_this);
    ...
    _createClass(Todo, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Input2.default, { submitFn: this.submitFn }),
                _react2.default.createElement(_List2.default, { todos: this.state.todos, delFn: this.delFn })
            );
        }
    }]);
            ...
            return _react2.default.createElement(
                ...
                data.map(function (item) {
                    return _react2.default.createElement(
                        'li',
                        { key: item.id,
                            onClick: _this2.clickHandler.bind(_this2, item.id) },
                        item.text
                    );
                })
            );
